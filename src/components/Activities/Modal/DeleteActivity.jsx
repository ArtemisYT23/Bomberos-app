import { openModalDeleteActivity } from "../../../redux/States/ModalAction";
...
export const DeleteActivity = () => {
  ...
  const { deleteActivity } = modalState;
  const [buttonActive, setButtonActive] = useState(false);

  const handleClose = () => {
    dispatch(openModalDeleteActivity(false));
  ...
  const ContainerCreate = (
    <ContainerModal>
      ...
      <AlertDelete>
        <label>Para que la actividad</label>
